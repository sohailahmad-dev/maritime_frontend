...
export default function Card({name = 'default', description = 'default', img='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2Z-Viu23Zi9aepAkisUn3zQAUzGBys45htQ&s', showControls, onEdit, onDelete  }) {
  return (
    ...
    <div className="course-card-body">
        ...
        {showControls ? <div className="course-card-btns-box">
            <Btn label='Details' className="course-card-btn" style={{ backgroundColor: 'green' }} />
